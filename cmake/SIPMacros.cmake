...
MACRO(ADD_SIP_PYTHON_MODULE MODULE_NAME MODULE_SIP)
    ...
    ADD_CUSTOM_COMMAND(
        ...
        COMMAND ${CMAKE_COMMAND} -E echo ${SIP_BINARY_PATH} ${_sip_tags} -w -e ${_sip_x} ${SIP_EXTRA_OPTIONS} -j ${SIP_CONCAT_PARTS} -c ${CMAKE_CURRENT_BINARY_DIR}/${_module_path} ${_sip_includes} ${_abs_module_sip}
