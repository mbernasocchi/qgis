...
ELSE(EXISTS PYQT4_VERSION)
  ...
  IF(PYQT4_FOUND)
    IF(NOT PYQT4_FIND_QUIETLY)
      MESSAGE(STATUS "PyQt4 PYQT4_VERSION_STR: ${PYQT4_VERSION_STR}")
      MESSAGE(STATUS "PyQt4 PYQT4_MOD_DIR: ${PYQT4_MOD_DIR}")
      MESSAGE(STATUS "PyQt4 PYQT4_SIP_DIR: ${PYQT4_SIP_DIR}")
      MESSAGE(STATUS "PyQt4 PYQT4_BIN_DIR: ${PYQT4_BIN_DIR}")
      MESSAGE(STATUS "PyQt4 PYQT4_SIP_FLAGS: ${PYQT4_SIP_FLAGS}")
