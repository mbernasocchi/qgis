...
ELSE(EXISTS PYQT4_VERSION)
  IF(ANDROID)
    FIND_FILE(_find_pyqt_py FindPyQtAndroid.py PATHS ${CMAKE_MODULE_PATH})
  ELSE(ANDROID)
  ...
  IF(PYQT4_FOUND)
    IF(NOT PYQT4_FIND_QUIETLY)
      MESSAGE(WARNING "PyQt4 PYQT4_VERSION_STR: ${PYQT4_VERSION_STR}")
      MESSAGE(WARNING "PyQt4 PYQT4_MOD_DIR: ${PYQT4_MOD_DIR}")
      MESSAGE(WARNING "PyQt4 PYQT4_SIP_DIR: ${PYQT4_SIP_DIR}")
      MESSAGE(WARNING "PyQt4 PYQT4_BIN_DIR: ${PYQT4_BIN_DIR}")
      MESSAGE(WARNING "PyQt4 PYQT4_SIP_FLAGS: ${PYQT4_SIP_FLAGS}")
